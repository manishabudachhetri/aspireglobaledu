...
const Germany: React.FC = () => {
  ...
  const faqs: FAQ[] = [
    { 
      q: 'Are German universities free for international students?',  
    ...
    { 
      q: 'What is the application process for German universities?',  
      a: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' 
    },
    {  
      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-35 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl font-bold">Study in Germany</h1>
            <p className="mt-2">
              <Link to="/" className="hover:text-[#FF8E3C]">Home</Link> /{" "}
              <Link to="/abroad-study" className="hover:text-[#FF8E3C]">Abroad Study</Link> / Germany
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="space-y-1">
              ...
              <h2 className="text-2xl font-semibold text-[#074293]">Study In Germany</h2>
            </div>
            <img 
              src="https://images.unsplash.com/photo-1592280771190-3e2e4d571952?w=2000&auto=format&fit=crop&q=80" 
            ...
            <section>
              <h3 className="text-xl font-semibold mb-2 text-[#074293]">Why Study in Germany?</h3>
              <p className="text-justify">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
              </p>
            </section>
