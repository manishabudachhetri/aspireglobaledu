...
const NewZealand: React.FC = () => {
  ...
  const faqs: FAQ[] = [
    { 
      q: 'What are the living costs in New Zealand?',  
      a: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'  
    },
    { 
      q: 'What are the admission requirements for New Zealand universities?',  
      a: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' 
    },
    { 
      q: 'Can international students work in New Zealand while studying?',  
      a: 'Lorem  ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' 
    },
    {  
      q: 'What scholarships are available for international students in New Zealand?',  
      a: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' 
    }
  ];
      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-35 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl font-bold">Study in New Zealand</h1>
            <p className="mt-2">
              <Link to="/" className="hover:text-[#FF8E3C]">Home</Link> /{" "}
              <Link to="/abroad-study" className="hover:text-[#FF8E3C]">Abroad Study</Link> / New Zealand
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="space-y-1">
              ...
              <h2 className="text-2xl font-semibold text-[#074293]">Study In New Zealand</h2>
            </div>
            <img 
              src="https://images.unsplash.com/photo-1507699622108-4be3abd695ad?w=2000&auto=format&fit=crop&q=80" 
              alt="New Zealand University" 
            ...
            <section>
              <h3 className="text-xl font-semibold mb-2 text-[#074293]">Why Study in New Zealand?</h3>
              <p className="text-justify">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
              </p>
            </section>
  ...
  <Link
    key={index}
    to={`/abroad-study/${study.toLowerCase().replace('study in ', '').replace(' ', '-')}`}
    replace={true}
