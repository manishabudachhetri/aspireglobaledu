...
const UK: React.FC = () => {
  ...
  const faqs: FAQ[] = [
    { 
      q: 'What are the costs of studying in the UK?',  
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="space-y-1">
              ...
              <h2 className="text-2xl font-semibold text-[#074293]">Study In UK</h2>
            </div>
            <img 
            ...
            <section>
              <h3 className="text-xl font-semibold mb-2 text-[#074293]">Why Study in UK?</h3>
              <p className="text-justify">
