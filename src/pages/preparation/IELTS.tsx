      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-35 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl font-bold">International English Language Testing System</h1>
            <p className="mt-2">
              <Link to="/" className="hover:text-[#FF8E3C]">Home</Link> /{" "}
              <Link to="/preparation" className="hover:text-[#FF8E3C]">Test Preparation</Link> / IELTS
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-6 order-2 md:order-1">
            <div>
              ...
              <h2 className="text-[#074293] text-3xl font-bold mb-6">International English Language Testing System</h2>
            </div>
