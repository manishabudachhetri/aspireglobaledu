      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-35 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl font-bold">Test of English as a Foreign Language (TOEFL)</h1>
            <p className="mt-2">
              <Link to="/" className="hover:text-[#FF8E3C]">Home</Link> /{" "}
              <Link to="/preparation" className="hover:text-[#FF8E3C]">Test Preparation</Link> / TOEFL
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-6 order-2 md:order-1">
            <div>
              ...
              <h2 className="text-[#074293] text-3xl font-bold mb-6">TOEFL Preparation Course</h2>
            </div>
            
            <div className="relative h-[400px] overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1546410531-bb4caa6b424d?w=2070&auto=format&fit=crop"
                alt="TOEFL Test"
