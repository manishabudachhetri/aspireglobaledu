      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-35 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-3xl sm:text-4xl font-bold">Study Abroad</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-6 order-1">
            ...
            <div className="relative h-[400px] overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1530521954074-e64f6810b32d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3"
                alt="Study Abroad"
            ...
            <div className="prose max-w-none">
              <p className="text-gray-600 mb-4">
                Our study abroad program offers comprehensive support for students looking to pursue their education in Dubai, the UK, and Malta. We provide personalized guidance and detailed information about universities and courses.
              </p>

              <h3 className="text-[#074293] text-xl font-semibold mt-8 mb-4">Study Destinations:</h3>
              
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
                <li>Dubai - UAE's premier education hub</li>
                <li>United Kingdom - World-renowned universities</li>
                <li>Malta - European education excellence</li>
              </ul>

              <h3 className="text-[#074293] text-xl font-semibold mt-8 mb-4">Our Support Services Include:</h3>
